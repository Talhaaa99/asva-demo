...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="h-10 w-10 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
    >
